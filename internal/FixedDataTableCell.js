  ...
  _createClass(FixedDataTableCell, [{
    ...
    /*object*/
    {
      var _this$props2 = this.props,
          ...
          lastChild = _this$props2.lastChild,
          onColumnResize = _this$props2.onColumnResize,
          onColumnReorder = _this$props2.onColumnReorder,
          props = _objectWithoutProperties(_this$props2, ["height", "width", "columnKey", "isHeaderOrFooter", "isRTL", "touchEnabled", "rowIndex", "cell", "left", "align", "highlighted", "className", "lastChild", "onColumnResize", "onColumnReorder"]);
      ...
      if ( /*#__PURE__*/_react["default"].isValidElement(cell)) {
        content = /*#__PURE__*/_react["default"].cloneElement(cell, cellProps);
      } else if (typeof cell === 'function') {
        content = cell(cellProps);
      } else {
        content = /*#__PURE__*/_react["default"].createElement(_FixedDataTableCellDefault["default"], cellProps, cell);
      }
